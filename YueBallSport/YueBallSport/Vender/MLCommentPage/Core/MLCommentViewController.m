...
@interface MLCommentViewController ()<CommentContentCell_Delegate,UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, DataRequestDelegate,UIScrollViewDelegate>
{
    BOOL _didAddTimer;
    BOOL isLoadMore;
    BOOL isRefresh;
