...
- (void)shareSdkConfig {
     ...
     */
    [ShareSDK registerApp:@"196a4227442a0"
          ...
          onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo)
     {
         ...
         switch (platformType)
         {
             case SSDKPlatformTypeSinaWeibo:
                 ...
                 [appInfo SSDKSetupSinaWeiboByAppKey:@"2840174764"
                                           appSecret:@"3bf8e1b362e62cd41726cb80439523d6"
             ...
             case SSDKPlatformTypeWechat:
                 ...
                 break;
             case SSDKPlatformTypeQQ:
                 [appInfo SSDKSetupQQByAppId:@"1105855282"
                                      appKey:@"mWhKS9TqDY8AhD1L"
                                    authType:SSDKAuthTypeBoth];
                 break;
             default:
                 break;
