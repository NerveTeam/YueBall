...
- (void)viewDidLoad
{
    ...
    self.searchController.searchBar.placeholder = @"输入用户名/手机号查询好友";//NSLocalizedString(@"UISearchController", @"please add string file");
...
//    [self updateArray:searchController.searchBar.text];
   
}
-(void)updateArray:(NSString *)text{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DemoModel *model = [self.models objectAtIndex:indexPath.row];
    //添加好友
    if ([_delegate respondsToSelector:@selector(selectIndex:searchModel:)]) {
        [_delegate selectIndex:indexPath.row searchModel:model];
    }
}
/*
